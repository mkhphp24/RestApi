 ...
 * @final
 */
class restTestKernelDevDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/restTestKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'restTestKernelDevDebugContainer',
            ...
            'router.cache_class_prefix' => 'restTestKernelDevDebugContainer',
